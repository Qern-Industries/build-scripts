...
makepkg -sfCc --noconfirm 2>&1 | tee -a ~/packages/cronlog/"${year}/${month}/${day}/${time}"/6700k || true
...
makepkg -sfCc --noconfirm 2>&1 | tee -a ~/packages/cronlog/"${year}/${month}/${day}/${time}"/4700u || true
