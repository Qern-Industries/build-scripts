...
cat /home/eile/passphrase | makepkg -sfCc --sign 2>&1 | tee -a ~/packages/cronlog/"${year}/${month}/${day}/${time}"/6700k || true
...
cat /home/eile/passphrase | makepkg -sfCc --sign 2>&1 | tee -a ~/packages/cronlog/"${year}/${month}/${day}/${time}"/4700u || true
