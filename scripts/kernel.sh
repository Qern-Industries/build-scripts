...
sed -i "s|_EXT_CONFIG_PATH=${BWDIR}/reuse/cfg/kernel/desktop-6700k.cfg|_EXT_CONFIG_PATH=~/.config/frogminer/linux-tkg.cfg|g" ${BWDIR}/reuse/git/linux-tkg/customization.cfg || true
sed -i "s|_EXT_CONFIG_PATH=${BWDIR}/reuse/cfg/kernel/zenbook-14-4700u.cfg|_EXT_CONFIG_PATH=~/.config/frogminer/linux-tkg.cfg|g" ${BWDIR}/reuse/git/linux-tkg/customization.cfg || true
